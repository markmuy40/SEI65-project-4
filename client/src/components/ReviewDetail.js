...
//   const getData = async () => {
//     try {
//       const res = await axios.get(`/api/comment/${single}/`)
...
//   try { 
//     const res = await axios.delete(`/api/comments/${single}/${commentId}/`)
//     setResStatus(res)
//   } catch (error){
...
//   try { 
//     const res = await axios.delete(`/api/reviews/${single}/`)
//     setResStatus(res)
//     window.location.reload(navigate('/api/reviews/'))
//   } catch (error){
//     setResStatus(error.response)
//   }
// }
...
//   try { 
//     const res = await axios.put(`/api/comment/${single}/${commentId}`, body)
//     setResStatus(res)
//     setUpdating('')
//   } catch (error){
...
//   try {
//     const res = await axios.post(`/api/comments/${single}`, body)
//     setResStatus(res)
//   } catch (error){
//     setResStatus(error.response)
//   }
...
//     const res = await axios.put(`/api/reviews/${Id}`, body)
//     setResStatus(body)
